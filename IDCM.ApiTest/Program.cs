...
namespace IDCM.ApiTest
{
    class Program
    {
        private readonly static string host = "http://preapi.idcm.io:8303";
        private readonly static string ApiKey = "XXXX";
        private readonly static string SecretKey = "XXXX";

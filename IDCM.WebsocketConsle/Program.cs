...
using IDCM.WebsocketConsle.Util;
...
namespace IDCM.WebsocketConsle
{
    class Program
    {
        private readonly static string URL = "ws://prereal.idcm.io:10330/websocket";
        private readonly static string ApiKey = "XXXX";
        private readonly static string ApiSecretKey = "XXXX";
        ...
        static void AddChannelTest()
        {
            ...
            using (var ws = new WebSocket(URL))
            {
                ...
                {
                    Event = @event,
                    Channel = "idcm_sub_spot_GEX-USDT_deals"
                };
                var data = JsonConvert.SerializeObject(baseEvent);
                ws.Connect();
                Login(ws);
